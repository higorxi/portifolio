...
export default function Footer(){
    return(
<footer class="bg-white  shadow dark:bg-neutral-950">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">GiovaneDev™</a>. Todos os direitos reservados.</span>
    </div>
